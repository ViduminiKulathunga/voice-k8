...
function CreateBooking() {
  ...
  const submitHandler = (e) => {
    ...
    if (
      !isPossibleNumber(bookingInfo.phonenumber) ||
      !isValidPhoneNumber(bookingInfo.phonenumber)
    ) {
  ...
  return (
    <MainScreen title="Book Your Slot">
        ...
        <Col md={8} xs={12} className="position-relative">
          {showSuccess && (
            <Alert variant="success">
              ...
              <p>
                Your booking is confirmed. Somebody from the team contact you
                soon.
              </p>
            </Alert>
          )}
                ...
                <Form className="row" onSubmit={(e) => submitHandler(e)}>
                  ...
                  <Form.Group className="mb-2 col-6" controlId="service">
                    ...
                    >
                      ...
                      <option disabled>
                        Job support will not ne entertained
                      </option>
                    </Form.Control>
                    <Form.Text className="text-muted">
                      Payment can be done via Phonepe, G-Pay to {PAYMENT_NUMBER}
                      .<br />
                      Through PayPal send it to Vidumini
                    </Form.Text>
                  </Form.Group>
      ...
      <div className="text-center py-2">
        ...
        <a style={{ textDecoration: "none" }} href={`mailto:${CONTACT_EMAIL}`}>
          {CONTACT_EMAIL}
        </a>{" "}
        or 7975977658
      </div>
        ...
        <Modal.Body>
          <Row>
            <Col md={5}>
              ...
              <div className="py-2 text-right text-secondary">
                Payment Screenshot:{" "}
              </div>
            </Col>
            <Col md={7}>
              ...
              <div className="py-2">
                <img src={pic[1]} alt="Payment Screenshot" width={250} />
              </div>
            </Col>
          </Row>
        </Modal.Body>
